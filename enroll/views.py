...
def job_search(request):
	if request.user.is_authenticated:
		if request.method == 'POST' and request.FILES['myfile']:
			...
			technicalSkillExtracted = ResumeSkillExtractor(resumeTechnicalSkillSpecificationList,filteredTextForSkillExtraction)		
			dataList = {"candi_skills":technicalSkillExtracted}
...
"""-----------------------------------------------------------------------------"""
filteredTextForSkillExtraction = stopWordRemoval(obtainedResumeText)
resumeTechnicalSkillSpecificationList = {}
"""-----------------------------------------------------------------------------"""
...
def disp_cp(request):
	...
	return render(request,'enroll/disp_cp.html',{'dd':data,'count' : job_paginator.count,'page' : page})
